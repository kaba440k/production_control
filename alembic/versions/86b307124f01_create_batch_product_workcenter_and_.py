"""Create batch, product, workcenter and webhooks models

Revision ID: 86b307124f01
Revises: 
Create Date: 2026-04-11 19:55:11.154701
...
def upgrade() -> None:
    ...
    sa.Column('nomenclature', sa.String(length=200), nullable=False),
